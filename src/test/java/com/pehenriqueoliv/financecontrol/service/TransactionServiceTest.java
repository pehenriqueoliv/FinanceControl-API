...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("Should throw BusinessException when category type mismatches transaction type")
    void shouldThrowWhenCategoryTypeMismatch() {
        ...
        assertThrows(BusinessException.class, () -> transactionService.create(request));
    ...
    void shouldThrowWhenUserNotFound() {
        ...
        when(userService.findEntityById(1L))
    ...
    void shouldThrowWhenUpdatingNonExistentTransaction() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> transactionService.update(99L, request));
